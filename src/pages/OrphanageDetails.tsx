...
export default function OrphanageDetails() {
  ...
  const route = useRoute() //dados da rota da página, como parâmetros passados e tals

  //afirmando que o obj passado tem o mesmo formato da interface que foi definida
  ...
  function handleOpenGoogleMapRoutes(){
    ...
    // ? para verificar se o componente existe antes de usar a propriedade, pois ele pode ser nulo ainda
  }
    ...
    <ScrollView style={styles.container}>
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled> 
          {/* pagingEnabled: paginação entre imagens, mostrando uma inteira por vez */}
